...
const reserva4: Reserva = {
  ...
  esGarantiaNoShow: false,
  medioPago: 'PENDIENTE',
  notasInternas: '3 amigas brasileñas. Aplicar promoción de bienvenida 10%. Falta confirmación de pago y garantía en 48h.',
  requerimientosEspeciales: [
    { id: generateUUID(), reservaId: 'RES-R1004', categoria: 'HABITACION', descripcion: 'Asignar CAB-04 (cabaña triple con balcón y vista parcial al jardín).', prioridad: 'ALTA', estado: 'PENDIENTE', ...auditSeed },
  ...
  checkInInfo: null,
  checkOutInfo: null,
  historialCambios: auditoriaReserva().map((h) => ({ ...h, reservaId: 'RES-R1004', valorNuevo: 'Reserva web oficial (3 pax, 3 noches cabaña triple) pendiente de confirmación y pago.' })),
  ...auditSeed
};
